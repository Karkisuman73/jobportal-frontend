          ...
          <>
            ...
            <div className="md:col-span-1 flex flex-col items-center text-center">
              <img
                ...
                alt="Profile"
              />
              <h2 className="mt-4 text-xl font-semibold">{result.jobpreference}</h2>
              ...
              <div className="mt-4">
                ...
                <div className="flex flex-wrap justify-center gap-2">
                  {result.skills?.split(",").map((skill, i) => (
                    <span key={i} className="bg-gray-100 text-blue-800 font-medium px-3 py-1 rounded-full text-sm">
                      {skill}
                    </span>
                  ))}
                </div>
